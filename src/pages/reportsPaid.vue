        ...
        <div>
            ...
            <div class="q-ma-md row">
                <q-card class="q-ma-md" style="width: 300px; height: 50px">
                    <q-item>
                        <q-item-section>
                        <q-item-label><strong>Total Paid Amount:</strong></q-item-label>
                        </q-item-section>
                        <q-item-section side>
            ...
            <q-table title="Client Reservation Reports" :data="eventsReports" :columns="columns" row-key="name">
                <template v-slot:body="props">
                    <q-tr>
                        ...
                        <q-td key="clientPaidAmount" :props="props">{{props.row.clientPaidAmount}} php</q-td>
                    ...
                    <q-card-section>
                            <div>
                                ...
                                <q-item>
                                    ...
                                    <q-item-section>
                                    <q-item-label overline>Total Paid Amount</q-item-label>
                                    </q-item-section>
                                    <q-item-section>
                                ...
                                <q-list v-for="(i, index) in  this.eventsReports" :key="index" dense>
                                    <q-item clickable v-ripple>
                                        ...
                                        <q-item-section>
                                            <q-item-label lines="1">&nbsp;&nbsp;&nbsp;&nbsp;{{i.clientPaidAmount}}</q-item-label>
                                        </q-item-section>
                                        <q-item-section>
...
export default {
    ...
    data(){
        return{
            ...
            columns: [
                ...
                { name: 'clientPaidAmount', align: 'left', label: 'Client Total Payment', field: 'clientPaidAmount', sortable: true },
    ...
    computed: {
        ...
        cpPrice(){
            if(this.filter == 'ONLINE'){
                let total = this.$lodash.sumBy(this.returnOnlineReservation, 'clientPaidAmount')
                console.log(total, 'sss')
                return total
            }else if(this.filter == 'WALK-IN'){
                let total = this.$lodash.sumBy(this.returnWalkinReservation, 'clientPaidAmount')
                // console.log(sss, 'sss')
                return total
            }else if(this.filter == 'W/Balance'){
                let total = this.$lodash.sumBy(this.returnWithBalance, 'clientPaidAmount')
                // console.log(sss, 'sss')
                return total
            }else if(this.filter == 'W/OBALANCE'){
                let total = this.$lodash.sumBy(this.returnWithOutBalance, 'clientPaidAmount')
                // console.log(sss, 'sss')
                return total
            }else{
                let total = this.$lodash.sumBy(this.returnWalkinReservation, 'clientPaidAmount')
